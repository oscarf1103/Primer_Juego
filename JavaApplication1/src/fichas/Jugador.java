        ...
        if (contadorSeis != 3) {
            if (movimientos == 6) {
                ...
                if(contadorSeis == 3) {
                    posicionX = tableroXI;
                    posicionY = tableroYI;
                    interfaz.mostrarAviso("El jugador("+(turno+1)+") llamado "+nombre+" ha sacado 3 veces seguidas 6. Por eso su ficha será enviada al inicio.");
                }
            } else {
                contadorSeis = 0;
            }
