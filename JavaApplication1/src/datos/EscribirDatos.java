...
public class EscribirDatos extends Datos {
    ...
    /**
     *Aqui se crea el constructor de la clase
     */
    ...
    /**
     * Revisamos si es posible agregar el comienzo y final del tablero correctamente
     * 
    ...
    /**
     *Se válida si existe o no una serpiente en una casilla especificada
     * 
     * @param x
     * @param y
    ...
    /**
     *Se válida si existe o no una escalera en una casilla especificada
     * 
     * @param x
     * @param y
     * @param serpientes Los datos de las serpientes existentes
    ...
    /**
     * Se válida los datos de la serpiente para saber si fueron ubicadas correctamente
     * Validacion:
     *      -Se válida si la serpiente se puede colocar en el espacio asignado por el tablero (Inicio-fin)
     *      -Valida si xi >= xf
     * 
     * @param xi inicial x
     * @param yi inicial y
     ...
     * @return validación boolean true si pasa la validacion
     */
    ...
    /**
     * Se válida los datos de la escalera para saber si fueron ubicadas correctamente
     * Validación:
     *      -Se válida si la serpiente se puede colocar en el espacio asignado por el tablero (Inicio-fin)
